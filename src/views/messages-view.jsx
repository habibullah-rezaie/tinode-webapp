...
// ICONS
import { BsFolderCheck, BsPersonLinesFill } from "react-icons/bs";
...
const messages = defineMessages({
	...
	//Tabibvisit BUTTON messages
	end_visit: {
		id: "end_visit",
		defaultMessage: "End Visit",
	},
	visit_summary: {
		id: "visit_summary",
...
class MessagesView extends React.Component {
	...
	handleMessageUpdate(msg) {
		...
		this.setState(
			{ messageCount: topic.messageCount(), typingIndicator: false },
			(_) => {
			...
			if (this.state.imagePreview) {
				...
				component2 = (
					<>
						...
						{/* Render buttons here */}
						{/* Below header and error panel and above spinner */}
						<TabibVisitButtons formatMessage={formatMessage} />
						...
						{this.state.unconfirmed ? (
							...
							<SendMessage
								...
								onAttachImage={
									this.props.forwardMessage ? null : this.handleAttachImage
								}
								onAttachAudio={
...
function TabibVisitButtons({ formatMessage }) {
	return (
		<div style={{ width: "100%" }}>
			<ul className="tabibBtns">
				<li className="tabibBtns__item">
					<TabibVisitBtn
						Icon={BsFolderCheck}
						title={formatMessage(messages.end_visit)}
					/>
				</li>
				<li className="tabibBtns__item">
					<TabibVisitBtn
						Icon={MdOutlineSummarize}
						title={formatMessage(messages.visit_summary)}
					/>
				</li>
				...
				<li className="tabibBtns__item">
					<TabibVisitBtn
						Icon={BiNotepad}
						title={formatMessage(messages.treatment_history)}
					/>
				</li>
				<li className="tabibBtns__item">
					<TabibVisitBtn
						Icon={BsPersonLinesFill}
						title={formatMessage(messages.temperament)}
					/>
				</li>
			</ul>
		</div>
...
function TabibVisitBtn({ title, Icon }) {
	return (
		<button className="tabibBtns__btn" aria-label={title}>
			...
			<div className="tabibBtns__text">{title}</div>
		</button>
	);
}
